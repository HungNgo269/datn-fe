            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                <div className="order-2 space-y-5 md:order-1">
                    <UploadBookButton
                        ...
                        buttonText={fileLabel || "Chỉ file EPUB/PDF"}
                        required={!isEdit}
                ...
                <div className="order-1 flex flex-col border-border md:order-2 md:border-l md:pl-8">
                    ...
                    <div className="group flex min-h-[200px] flex-1 flex-col items-center justify-start rounded-xl border border-dashed border-slate-200 bg-slate-50 p-4 transition-colors hover:bg-slate-100">
                        {coverPreview ? (
                            <ImagePreview
                                src={coverPreview}
                                alt="Cover preview"
