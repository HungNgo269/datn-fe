...
import { createBookPromotion } from "@/app/feature/promotions/api/promotions.api";
import type { CreateBookPromotionDto, PromotionType } from "@/app/feature/promotions/types/promotions.types";

export default function CreateBookPromotionPage() {
  ...
  const createMutation = useMutation({
    mutationFn: createBookPromotion,
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["promotions"] });
      toast.success("Tạo khuyến mãi sách thành công");
  ...
  const handleSubmit = useCallback(() => {
    ...
    const dto: CreateBookPromotionDto = {
      name: name.trim(),
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col gap-1">
            <h1 className="text-2xl font-bold tracking-tight">
              Tạo khuyến mãi sách mới
            </h1>
            <p className="text-slate-600">
              Điền thông tin để tạo chương trình khuyến mãi cho sách
            </p>
          </div>
        </div>
