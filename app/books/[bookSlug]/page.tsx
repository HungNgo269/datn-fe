  ...
  return (
    <>
      ...
      <div className="min-h-screen relative flex flex-col bg-background">
        <div className="container relative z-10 mx-auto px-4 pt-8 md:pt-16 max-w-[1200px] flex-grow">
            ...
            <div className="flex-1 flex flex-col w-full text-">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto mt-auto">
                ...
                {firstChapter && (
                  ...
                  >
                    <Button className="w-full sm:w-[180px] h-12 text-base font-bold bg-white text-black hover:bg-gray-200 border-none rounded-md shadow-lg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8 pb-20">
            ...
            {/* Mobile Sidebar (Optional: Nếu muốn hiện recommend ở dưới cùng trên mobile) */}
